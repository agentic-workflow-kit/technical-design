...
**Product identity.** technical-design is a self-contained pack of AI skills and supporting evaluation tools for technical design. It is meant to be useful two ways: **on its own**, for anyone who needs to author and review software designs, and as the **Design layer** of the agentic-workflow-kit suite — in both cases producing design documents that conform to the [technical-design-handoff-contract](../design/technical-design-handoff-contract.md).
...
| AC-AUTHOR-003 | When design diagrams are generated, author-technical-design ensures they trace strictly to approved entities, flows, or boundaries without inventing scope. | Active |
